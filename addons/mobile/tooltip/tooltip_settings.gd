...
var _tooltip_settings: EditorResourcePicker
...
func _ready() -> void:
	...
	_tooltip_settings = FAST_SETTINGS_SCENE.new("MobileTooltipFastSettings")
	%FastSettingsContainer.add_child(_tooltip_settings)
	
	_tooltip_settings.resource_changed.connect(
...
func set_fast_settings_data(data: Dictionary) -> void:
	_tooltip_settings.set_data(data)
...
func _on_enable_toggled(button_pressed: bool) -> void:
	...
	%AvailableSettings.visible = button_pressed
...
#		return
	...
	_tooltip_settings.edited_resource = null
	%custom_settings_editor_enabler.disabled = true
...
func get_data() -> Dictionary:
	var data := {}
	var tooltip_settings: Array = Mobile.Tooltip.MetaProperties.values()
